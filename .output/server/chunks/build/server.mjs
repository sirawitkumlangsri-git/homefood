...
const _routes = [
  {
    name: "admin",
    path: "/admin",
    component: () => import('./index-D6fe4w9w.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dr6v8sLn.mjs')
  },
  {
    name: "orderfood",
    path: "/orderfood",
    component: () => import('./index-A4kUBRGt.mjs')
  },
  {
    name: "ordershop",
    path: "/ordershop",
    component: () => import('./index-CnyFBvfT.mjs')
  },
  {
    name: "packet",
    path: "/packet",
    component: () => import('./index-FJQNK83Z.mjs')
  },
  {
    name: "productsale",
    path: "/productsale",
    component: () => import('./index-BFl0Rq5c.mjs')
  },
  {
    name: "recommendedshops",
    path: "/recommendedshops",
    component: () => import('./index-BCo73Vxc.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D8biQBYf.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BS2WwZrD.mjs'));
...
export { _export_sfc as _, navigateTo as a, useNuxtApp as b, useRuntimeConfig as c, withoutTrailingSlash as d, resolveUnrefHeadInput as e, createError as f, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseQuery as p, resolveRouteObject as r, server as s, useRouter as u, withTrailingSlash as w };
