...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="p-4 flex font-prompt mx-auto max-w-7xl mt-6" data-v-d7a83d7f>`);
      _push(ssrRenderComponent(_component_RouterLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-d7a83d7f${_scopeId}><path fill-rule="evenodd" clip-rule="evenodd" d="M11.4078 5.92548C11.7251 6.24278 11.7251 6.75722 11.4078 7.07452L6.2948 12.1875H21.6666C22.1153 12.1875 22.4791 12.5513 22.4791 13C22.4791 13.4487 22.1153 13.8125 21.6666 13.8125H6.2948L11.4078 18.9255C11.7251 19.2428 11.7251 19.7572 11.4078 20.0745C11.0905 20.3918 10.576 20.3918 10.2587 20.0745L3.75873 13.5745C3.44143 13.2572 3.44143 12.7428 3.75873 12.4255L10.2587 5.92548C10.576 5.60817 11.0905 5.60817 11.4078 5.92548Z" fill="#0D1217" data-v-d7a83d7f${_scopeId}></path></svg>`);
          } else {
            return [
      ...
      _push(`<div class="flex-1 mt-2" data-v-d7a83d7f><h2 class="text-3xl mx-16 font-bold" data-v-d7a83d7f>\u0E2A\u0E31\u0E48\u0E07\u0E2D\u0E32\u0E2B\u0E32\u0E23</h2></div></div>`);
      _push(ssrRenderComponent(_sfc_main$3, { class: "font-prompt" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="" data-v-d7a83d7f${_scopeId}>`);
            _push2(ssrRenderComponent(unref(Search), null, null, _parent2, _scopeId));
            _push2(`</div><div data-v-d7a83d7f${_scopeId}>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-d7a83d7f"]]);

export { index as default };
//# sourceMappingURL=index-BYYxIJ1V.mjs.map
