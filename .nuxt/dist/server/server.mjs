...
const _routes = [
  ...
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-BwjsDmF5.js")
  },
  {
    name: "orderfood",
    path: "/orderfood",
    component: () => import("./_nuxt/index-UMUDEwTm.js")
  },
  {
    name: "ordershop",
    path: "/ordershop",
    component: () => import("./_nuxt/index-Dlvp3okc.js")
  },
  {
    name: "packet",
    path: "/packet",
    component: () => import("./_nuxt/index-Cev7sl5U.js")
  },
  {
    name: "productsale",
    path: "/productsale",
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-NyMCHnXK.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
