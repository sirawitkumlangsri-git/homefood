import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { PrismaClient } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/@prisma/client/default.js';
import jwt from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/jsonwebtoken/index.js';
import { useRouter } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/vue-router/dist/vue-router.node.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/devalue/index.js';
import destr from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/vue/index.mjs';
import { hash } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/node_modules/@unhead/shared/dist/index.mjs';
...
const _h5Ti4iITog = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/sirawitkumlungsri/Documents/GitHub/homefood";
...
const _lazy_uB47Iw = () => Promise.resolve().then(function () { return _id_$1; });
const _lazy_fHWUm5 = () => Promise.resolve().then(function () { return users$1; });
const _lazy_RahTAZ = () => Promise.resolve().then(function () { return login_post$1; });
const _lazy_oBT5tZ = () => Promise.resolve().then(function () { return register_post$1; });
const _lazy_mf3LEy = () => Promise.resolve().then(function () { return user$1; });
const _lazy_m8HrGF = () => Promise.resolve().then(function () { return renderer$1; });
...
const serverAssets = [{"baseName":"server","dir":"/Users/sirawitkumlungsri/Documents/GitHub/homefood/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sirawitkumlungsri/Documents/GitHub/homefood","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/sirawitkumlungsri/Documents/GitHub/homefood/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sirawitkumlungsri/Documents/GitHub/homefood/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/sirawitkumlungsri/Documents/GitHub/homefood/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/sirawitkumlungsri/Documents/GitHub/homefood/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const register_post = defineEventHandler(async (event) => {
  ...
  const newUser = await prisma$1.user.create({
    data: {
      email,
      phoneNumber,
      fullname
...
const getClientManifest = () => import('file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/sirawitkumlungsri/Documents/GitHub/homefood/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
